...
import {
  ...
  deleteById,
  download
} from '@/components/bpm-web-ui/api/process/process'
import { getDictListByDictCode } from '@/components/bpm-web-ui/api/system/dict'
import { getCompanyDict, getById } from '@/components/bpm-web-ui/api/system/company'
import { publish, getProcessDetailById } from '@/components/bpm-web-ui/api/process/processDetail'

// import waves from '@/components/bpm-web-ui/directive/waves'
// import store from '@/components/bpm-web-ui/store'

import ShowDiagram from '@/components/bpm-web-ui/ShowDiagram/index'
import diagramManager from '@/components/bpm-web-ui/DiagramManager/index'
import processVersion from './processVersion.vue'

export default {
  name: 'BpmnWebUi',
  components: { ShowDiagram, diagramManager, processVersion },
  directives: {  },
  filters: {
    statusFilter(status) {
      const statusMap = {
