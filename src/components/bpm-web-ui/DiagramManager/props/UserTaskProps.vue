...
import { getRoleDict, getRoleGroupDict } from '@/components/bpm-web-ui/api/system/dict'
// import store from '@/components/bpm-web-ui/store'
import selectUser from '@/components/bpm-web-ui/common/selectUser.vue'
...
export default {
  ...
  methods: {
    ...
    getRoleGroupDict() {
      ...
      getRoleGroupDict(1).then(response => (
