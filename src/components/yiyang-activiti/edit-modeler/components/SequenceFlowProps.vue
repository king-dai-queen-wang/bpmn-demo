                                ...
                                <div v-if="formShow === true">
                                    <el-form label-width="auto" size="mini" label-position="top">
                                        <el-form-item label="变量">
                                            <el-input v-model="tempVarible" @keyup.native="inputVarible"  />
...
export default {
    ...
    methods:{
        ...
        openDialog(){
            ...
            console.log(this.table.conditions,"##############");
        ...
        parseCondition(conditionExpress){
            ...
            function splitConditionExpress(str){
                ...
                if(idx == -1){
                    ...
                    if(!row.conditionalValLabel){row.conditionalValLabel = row.conditionalVal}
                    self.table.conditions.push(row);
                    console.log(row,"@@@@@1")
                    self.conditionList.push({
                        TEXT:row.variable,
                        VALUE:row.variable,
                    });
                    return;
    ...
    watch:{
        ...
        'form.conditionalOpt':function(newVal,oldVal){
            ...
            let currentRow =this.table.selectedRow;
            console.log(variableInfo,"________");
            if(currentRow){
                if(variableInfo){
                    let index = findIndex(this.table.conditions,{id:currentRow.id});
                    // if(variableInfo.type == 'result'){
        ...
        'table.selectedRow':{
            ...
            handler:function(newVal){
                if(newVal !== undefined){
                    this.formShow = true;
                    this.tempVarible = newVal.variable;
